    ...
    <div className="container mx-auto max-w-7xl px-4 py-8 pb-24">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        {paginatedETFs.map((etf) => (
          <Card
            key={etf.ticker}
            className="group/card relative flex flex-col transition-all duration-200 hover:scale-[1.02] hover:shadow-lg"
          >
          ...
          <div className="container mx-auto flex max-w-7xl items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <p className="text-sm font-medium">
                {selectedForComparison.size} ETF
                {selectedForComparison.size > 1 ? "s" : ""} selected for
                comparison
              </p>
