    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Your portfolio has been optimized based on your risk profile and
            preferences
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold">
                  {formatPercent(portfolio.totalFees)}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-muted-foreground">
            ...
            <div className="space-y-3">
              <div>
                ...
                <div className="text-sm text-muted-foreground">
                  Max {formatPercent(portfolio.constraints.volatilityCap)}{" "}
                  annual volatility
                </div>
              </div>
              <div>
              ...
              {portfolio.constraints.excludedIndustries.length > 0 && (
                <div>
                  <div className="mb-1 text-sm font-medium">ESG Exclusions</div>
                  <div className="flex flex-wrap gap-1">
                    {portfolio.constraints.excludedIndustries.map(
                      (industry) => (
                        <Badge
                          key={industry}
                          variant="secondary"
          ...
          <div className="flex gap-3">
            ...
            <div className="space-y-1 text-sm">
              ...
              <p className="text-yellow-800">
                This portfolio recommendation is based on mathematical
                optimization and your risk profile. Past performance does not
                guarantee future results. Please consult with a qualified
